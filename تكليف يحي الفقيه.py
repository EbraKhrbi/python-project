...
a=int (input("enter number:")) group=[1,5,8,3,3] 
if a in group:
print(True)
 else:
print(False)
...
self.length=length 
self.width=width 
def area_rectangle (self,length,width): area=length*width return area
def mference_rectangle (self,length,width): mference1=2*(length+width) 
return mference1
